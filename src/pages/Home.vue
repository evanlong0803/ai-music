<template>
	<div
		class="home"
		:style="{ overflow: openLogin || showSearchBox ? 'hidden' : '' }"
	>
		<!-- 回到顶部 -->
				...
				>
					...
					<el-col>
						<nav class="home-nav">
							...
							<router-link to="/" exact-active-class="click"
								>发现音乐</router-link
							>
							<router-link to="/rank" exact-active-class="click"
								>排行榜</router-link
							>
							<router-link to="/songsheet" exact-active-class="click"
								>歌单</router-link
							>
							<router-link to="/singer" exact-active-class="click"
								>歌手</router-link
							>
						...
						<div class="home-login">
							...
							<el-dropdown trigger="click" v-else>
								...
								<el-dropdown-menu slot="dropdown">
									<el-dropdown-item
										icon="el-icon-user"
										@click.native="goPersonal(userInfo.userId)"
										>个人主页</el-dropdown-item
									>
									<el-dropdown-item icon="el-icon-medal" @click.native="goGrade"
										>我的等级</el-dropdown-item
									>
									<el-dropdown-item
										icon="el-icon-setting"
										@click.native="goSetting(userInfo.userId)"
			...
			<el-footer height="240px">
				...
				<div class="bottom-copyright">
					<div class="copyright">
						...
						<a href="https://gitee.com/toolse/CookiesMusic" target="_blank"
							>代码仓库
						</a>
					</div>
				</div>
...
export default {
	...
	methods: {
		...
		// 退出登录
		async logout() {
			const { data: res } = await this.$api.logout();
			if (res.code !== 200) {
